...
export default class ScratchConversionOperator {
  ...
  convertOperatorBlock(
    ...
    switch (opcode) {
      ...
      case "operator_lt": {
        const { OPERAND1, OPERAND2 } = processInputs(
          blocks,
          currentBlockId,
          currentBlock,
          patchApi,
      ...
      case "operator_join": {
        const { STRING1, STRING2 } = processInputs(
          blocks,
          currentBlockId,
          currentBlock,
          patchApi,
