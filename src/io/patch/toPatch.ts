...
export interface ToPatchOptions {
  warn: (message: string) => void;
}

export interface ToPatchOutput {
  json: string;
}

export default function toPatch(project: Project, options: Partial<ToPatchOptions> = {}): ToPatchOutput {
  ...
  let warn: ToPatchOptions["warn"] = (): void => undefined;
  if (options.warn) {
    warn = options.warn;
  }
